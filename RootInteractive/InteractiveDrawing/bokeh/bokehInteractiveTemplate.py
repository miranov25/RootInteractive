...
def getDefaultVarsRefWeights(variables=None, defaultVariables={}, weights=None, weightsRef=None, multiAxis=None):
    ...
    figureArray=[
        ...
        [["bin_center_0"], ["diffFuncWeights(histoXYZData_1.mean, projXYZRef_1.mean)"], { "source":"histoXYZData_1_join","errY":"sqrt(histoXYZData_1.std**2+projXYZRef_1.std**2)/sqrt(entries)", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleWeightsMean,"colorAxisTitle":"{varZ}"}],
        [["bin_center_0"], ["diffFuncWeights(histoXYZData_1.quantile_1, projXYZRef_1.quantile_1)"], { "source":"histoXYZData_1_join","errY":"std/sqrt(entries)", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleWeightsMedian,"colorAxisTitle":"{varZ}"}],
        ...
        [["bin_center_0"], ["diffFuncWeights(histoXYNormZData_1.mean, projXYNormZRef_1.mean)"], { "source":"histoXYNormZData_1_join","errY":"sqrt(histoXYNormZData_1.std**2+projXYNormZRef_1.std**2)/sqrt(entries)", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleNormWeightsMean,"colorAxisTitle":"{varZ}"}],
        [["bin_center_0"], ["diffFuncWeights(histoXYNormZData_1.quantile_1, projXYNormZRef_1.quantile_1)"], { "source":"histoXYNormZData_1_join","errY":"std/sqrt(entries)", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleNormWeightsMedian,"colorAxisTitle":"{varZ}"}],
