...
def getDefaultVarsRefWeights(variables=None, defaultVariables={}, weights=None, weightsRef=None, multiAxis=None):
    ...
    figureArray=[
        ...
        [["bin_center_0"], ["diffFuncWeights(histoXYNormZData_1.mean, projXYNormZRef_1.mean)"], { "source":"histoXYNormZData_1_join","errY":"sqrt(histoXYNormZData_1.std**2+projXYNormZRef_1.std**2)/sqrt(entries)", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","colorAxisTitle":"{varZ}"}],
        [["bin_center_0"], ["diffFuncWeights(histoXYNormZData_1.quantile_1, projXYNormZRef_1.quantile_1)"], { "source":"histoXYNormZData_1_join","errY":"std/sqrt(entries)", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","colorAxisTitle":"{varZ}"}],
        [["bin_center_0"], ["diffFuncWeights(histoXYNormZData_1.std, projXYNormZRef_1.std)"], { "source":"histoXYNormZData_1_join", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","colorAxisTitle":"{varZ}"}],
        # histoXYZNormMedian
        [[("bin_bottom_0", "bin_top_0")], [("bin_bottom_1", "bin_top_1")], {"colorZvar": "quantile_1", "source":"histoXYZData_2"}],
        [[("bin_bottom_0", "bin_top_0")], [("bin_bottom_1", "bin_top_1")], {"colorZvar": "quantile_1", "source":"histoXYZNormData_2"}],
        # histoXYZNormMean
