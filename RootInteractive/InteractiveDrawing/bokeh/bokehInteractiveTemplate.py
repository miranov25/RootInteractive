...
def getDefaultVarsRefWeights(variables=None, defaultVariables={}, weights=None, weightsRef=None, multiAxis=None):
    ...
    figureArray=[
        ...
        [["bin_center_0"], ["diffFuncWeights(histoXYNormData_1.mean, projXYNormRef_1.mean)", "diffFuncWeights(histoXYNormData_1.quantile_1, projXYNormRef_1.quantile_1)"], { "source":"histoXYNormData_1_join","xAxisTitle":"{varX}", "yAxisTitle":yAxisTitleNormWeightsMeanMedian}],
        [["bin_center_0"], ["diffFuncWeights(histoXYNormData_1.std, projXYNormRef_1.std)"], { "source":"histoXYNormData_1_join","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleNormWeightsStd}],
        ...
        [["bin_center_0"], ["diffFuncWeights(histoXYZData_1.mean, projXYZRef_1.mean)"], { "source":"histoXYZData_1_join", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleWeightsMean,"colorAxisTitle":"{varZ}"}],
        [["bin_center_0"], ["diffFuncWeights(histoXYZData_1.quantile_1, projXYZRef_1.quantile_1)"], { "source":"histoXYZData_1_join", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleWeightsMedian,"colorAxisTitle":"{varZ}"}],
        ...
        [["bin_center_0"], ["diffFuncWeights(histoXYNormZData_1.mean, projXYNormZRef_1.mean)"], { "source":"histoXYNormZData_1_join", "colorZvar": "bin_center_2","xAxisTitle":"{varX}","yAxisTitle":yAxisTitleNormWeightsMean,"colorAxisTitle":"{varZ}"}],
